...
export const FileExplorer = forwardRef<FileExplorerHandle, Props>(
  function FileExplorer(
    ...
    return (
      <div
        ref={containerRef}
        className="flex h-full flex-col outline-none supports-[backdrop-filter]:bg-background/70 supports-[backdrop-filter]:backdrop-blur-xl"
        tabIndex={0}
        onKeyDown={handleKeyDown}
      >
        <div className="flex h-7 shrink-0 items-center gap-1 border-b border-border/30 px-2">
          <Button
            variant="ghost"
            size="icon"
            ...
            aria-label="打开项目文件夹"
          >
            <HugeiconsIcon icon={Folder02Icon} size={13} strokeWidth={2} />
          </Button>
