    ...
    <TooltipProvider delayDuration={500} skipDelayDuration={200}>
      <div className="flex h-full min-h-0 flex-col bg-background [contain:layout_style]">
        {loadStatus === "initial" && commits.length === 0 ? (
          ...
          <>
            <div
              className="grid shrink-0 items-center gap-3 border-b border-border/40 bg-card/55 pr-3 text-[13px] font-semibold uppercase tracking-[0.14em] text-muted-foreground/70"
              style={{
            ...
            >
              ...
              <div className="min-w-0">提交信息</div>
              <div />
              <div className="ml-2">作者</div>
              <div className="text-right">日期</div>
              <div className="text-right">变更</div>
            </div>
            <div
              ref={scrollRef}
            ...
            >
              ...
              {endReached && !activeSearch ? (
                <div className="py-3 text-center text-[13px] text-muted-foreground/65">
                  已到历史记录末尾
                </div>
              ) : null}
              {loadStatus === "error" && commits.length > 0 ? (
...
const CommitRow = memo(function CommitRow({
  ...
  return (
    ...
    >
      ...
      <span className="pl-px font-mono text-[13px] tabular-nums text-muted-foreground/80">
        {commit.shortSha}
      </span>
      <span
        className={cn(
      ...
      >
        <span
          className="inline-flex size-3.5 shrink-0 items-center justify-center rounded-[3px] font-mono text-[10px] font-bold uppercase tabular-nums text-background"
          style={{
      ...
      <span className="text-right font-mono text-[13px] tabular-nums text-muted-foreground/75">
        {date}
      </span>
      <span className="flex min-w-0 items-center justify-end gap-1.5 font-mono text-[13px] tabular-nums">
  ...
  return (
    <div className="flex max-h-[60vh] min-h-0 flex-col">
      <div className="shrink-0 border-b border-border/45 p-3">
        ...
        <div className="mt-2 flex min-w-0 items-center gap-1.5 text-[13px] text-muted-foreground">
        ...
        <div className="mt-2.5 flex items-center gap-1">
          <Button
            size="xs"
            variant="ghost"
            className="h-6 cursor-pointer gap-1.5 px-1.5 text-[13px] text-muted-foreground hover:text-foreground"
            onClick={() => {
...
function CommitFiles({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      <div className="flex shrink-0 items-center justify-between px-3 pb-1 pt-2 text-[13px] font-semibold uppercase tracking-[0.16em] text-muted-foreground/85">
        <span>变更文件</span>
        <span className="rounded-sm bg-muted/55 px-1 py-px text-[13px] tabular-nums text-muted-foreground/85 normal-case tracking-normal">
  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 items-baseline gap-1.5 leading-none">
        ...
        {dir ? (
          <span className="min-w-0 flex-1 truncate text-[13px] leading-tight text-muted-foreground/80">
            {dir}
          </span>
        ) : null}
      </div>
