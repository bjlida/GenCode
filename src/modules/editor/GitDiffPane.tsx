  ...
  return (
    <div className="flex h-full min-h-0 flex-col rounded-md border border-border/60 bg-background">
      <div className="flex h-10 shrink-0 items-center justify-between gap-3 border-b border-border/60 px-3">
        ...
        <div className="flex shrink-0 items-center gap-3 text-[13px] tabular-nums text-muted-foreground">
      ...
      <div className="min-h-0 flex-1 overflow-hidden">
        {state.kind === "loading" || state.kind === "idle" ? (
          ...
          <ScrollArea className="h-full">
            <pre className="min-h-full whitespace-pre-wrap wrap-break-word p-4 font-mono text-[13px] leading-relaxed text-muted-foreground">
              {fallbackPatch || "此文件暂无差异预览。"}
            </pre>
          </ScrollArea>
        ) : (
          <CodeMirror
