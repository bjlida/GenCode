export const KEYRING_SERVICE = "gencode-ai";
...
export const MODELS = [
  ...
  // ── 通义千问 (Qwen / Alibaba) ──────────────────────────────────────────────
  {
    ...
    label: "Qwen Max",
    hint: "旗舰",
    description: "阿里通义千问旗舰模型，长文本推理能力强。",
    capabilities: { intelligence: 5, speed: 3, cost: 2 },
    tags: ["reasoning", "tools", "coding"],
  },
  {
  ...
  // ── Moonshot (月之暗面 / Kimi) ────────────────────────────────────────────
  {
    ...
    label: "Moonshot 128K",
    hint: "长文本",
    description: "128K 超长上下文，适合大型代码库。",
    capabilities: { intelligence: 4, speed: 3, cost: 3 },
    tags: ["tools", "coding"],
  },
  {
...
export const MODEL_PRICING: Record<string, ModelPricing> = {
  ...
  "qwen-max": { input: 2.4, output: 9.6, cacheRead: 0.24 },
  "qwen-plus": { input: 0.8, output: 2, cacheRead: 0.08 },
  "qwen-turbo": { input: 0.3, output: 0.6, cacheRead: 0.03 },
  "glm-4-plus": { input: 1.4, output: 1.4 },
  "glm-4-flash": { input: 0, output: 0 },
  "glm-4-long": { input: 1.4, output: 1.4 },
...
export const SYSTEM_PROMPT = `You are GenCode (灵码ADE), an AI agent embedded in a developer terminal emulator. You are a hands-on engineer, not a chat bot — your job is to *do* the work, not narrate it.
...
- Always respond in Chinese (Simplified Chinese, 简体中文). The UI is in Chinese and the user expects Chinese replies. Code identifiers and technical terms may stay in English.`;

export const SYSTEM_PROMPT_LITE = `You are GenCode (灵码ADE), an AI agent in a developer terminal. Each turn carries an <env> block (workspace_root, active_terminal_cwd, optional active_file) prepended to the user's message — treat as ground truth.
