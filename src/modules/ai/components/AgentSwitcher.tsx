  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="min-w-60">
        <div className="px-2 pt-1.5 pb-1 text-[13px] font-medium tracking-wide text-muted-foreground uppercase">
          内置
        </div>
        {builtIn.map((a) => {
        ...
        {custom.length > 0 ? (
          <>
            <DropdownMenuSeparator />
            <div className="px-2 pt-1 pb-1 text-[13px] font-medium tracking-wide text-muted-foreground uppercase">
              自定义
            </div>
            {custom.map((a) => {
              const Icon = ICONS[a.icon] ?? SparklesIcon;
