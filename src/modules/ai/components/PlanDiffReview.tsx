...
function UnifiedDiffPreview({
  ...
  return (
    <div className="overflow-hidden rounded border border-border/40 font-mono text-[13px] leading-relaxed">
      <div className="max-h-72 overflow-auto">
        ...
        {rest > 0 ? (
          <div className="px-2 py-1 text-[13px] italic text-muted-foreground">
            … 还有 {rest} 处变更
          </div>
        ) : null}
      </div>
