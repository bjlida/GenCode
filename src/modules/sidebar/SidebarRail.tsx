      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={cn(
              "group relative flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-md text-[15px] font-medium outline-none transition-colors duration-150",
          ...
          >
            ...
            {showBadge ? (
              <span className="inline-flex h-4 min-w-4 items-center justify-center rounded-full border border-border/60 bg-card px-1 text-[13px] font-semibold leading-none tabular-nums text-muted-foreground/95">
