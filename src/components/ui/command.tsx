...
function CommandSeparator({
  ...
  return (
    <CommandPrimitive.Separator
      ...
      className={cn("my-1.5 h-px bg-border/30", className)}
      {...props}
    />
  )
}
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-[11px] tracking-normal text-muted-foreground group-data-selected/command-item:text-foreground",
        className
      )}
      {...props}
    />
